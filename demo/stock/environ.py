...
class State:
    ...
    def reset(self, prices, offset):
        ...
        assert offset >= self.bars_count-1   # hoho: 为啥offset要这样定义？！不能从0开始？
    ...
    def encode(self):
        ...
        shift += 1
        if not self.have_position:  # 是否买了该股票
            res[shift] = 0.0
        else:
...
class StocksEnv(gym.Env):
    ...
    def reset(self):
        ...
        self._instrument = self.np_random.choice(list(self._prices.keys()))  # 股票机构
