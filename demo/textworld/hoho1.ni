...
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 are rooms.

Understand "studio" as r_0.
The internal name of r_0 is "studio".
The printed name of r_0 is "-= Studio =-".
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. A standard kind of place. You begin looking for stuff.

 You can see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The studio part 1 is some text that varies. The studio part 1 is " type D locker.[if c_0 is open and there is something in the c_0] The type D locker contains [a list of things in the c_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
The studio part 2 is some text that varies. The studio part 2 is "[if c_0 is open and the c_0 contains nothing] The type D locker is empty, what a horrible day![end if]".
...
The description of r_0 is "[studio part 0][studio part 1][studio part 2][studio part 3]".
...
The spare room part 0 is some text that varies. The spare room part 0 is "This might come as a shock to you, but you've just walked into a spare room. You can barely contain your excitement.

 You can make out [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is " usual looking crate close by.[if c_1 is open and there is something in the c_1] The crate contains [a list of things in the c_1].[end if]".
The spare room part 2 is some text that varies. The spare room part 2 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The crate is empty![end if]".
The spare room part 3 is some text that varies. The spare room part 3 is " You can make out a rack. [if there is something on the s_0]You see [a list of things on the s_0] on the rack.[end if]".
The spare room part 4 is some text that varies. The spare room part 4 is "[if there is nothing on the s_0]However, the rack, like an empty rack, has nothing on it.[end if]".
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You're not going to believe this, but you've just entered a dish-pit.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. A typical kind of place.
 ...
 You see a table. You shudder, but continue examining the table. [if there is something on the s_1]On the table you see [a list of things on the s_1].[end if]".
The cookery part 1 is some text that varies. The cookery part 1 is "[if there is nothing on the s_1]However, the table, like an empty table, has nothing on it.[end if]".
...
The o_1 and the o_4 and the o_0 and the o_2 and the o_3 are object-likes.
The o_1 and the o_4 and the o_0 and the o_2 and the o_3 are privately-named.
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 are rooms.
The r_0 and the r_1 and the r_2 and the r_3 and the r_4 are privately-named.
The s_0 and the s_1 are supporters.
The s_0 and the s_1 are privately-named.

The description of c_0 is "The type D locker looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_0 is in r_0.
The c_0 is closed.
The description of c_1 is "The crate looks strong, and impossible to break. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of c_1 is "crate".
Understand "crate" as c_1.
The c_1 is in r_1.
The c_1 is closed.
The description of o_1 is "The glass would seem to be well matched to everything else here".
The printed name of o_1 is "glass".
Understand "glass" as o_1.
The o_1 is in r_3.
The description of o_4 is "The fly larva is expensive looking.".
...
The s_1 is in r_4.
The description of k_0 is "The metal of the type D latchkey is brushed.".
The printed name of k_0 is "type D latchkey".
Understand "type D latchkey" as k_0.
...
The description of o_2 is "The teacup is cheap looking.".
...
Test quest0_0 with "go south / go east / go north / open type D locker / take keyboard from type D locker"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First stop, go to the south. And then, head east. With that over with, make an effo".
The objective part 1 is some text that varies. The objective part 1 is "rt to go north. With that accomplished, ensure that the type D locker is open. Then, take the keyboard from the type D locker. That's it!".
