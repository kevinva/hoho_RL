...
The r_1 and the r_4 and the r_2 and the r_0 and the r_3 are rooms.

Understand "basement" as r_1.
The internal name of r_1 is "basement".
The printed name of r_1 is "-= Basement =-".
The basement part 0 is some text that varies. The basement part 0 is "You find yourself in a basement. An usual one.

 [if c_0 is locked]A locked[else if c_0 is open]An open[otherwise]A closed[end if]".
The basement part 1 is some text that varies. The basement part 1 is " box is here.[if c_0 is open and there is something in the c_0] The box contains [a list of things in the c_0].[end if]".
The basement part 2 is some text that varies. The basement part 2 is "[if c_0 is open and the c_0 contains nothing] The box is empty! What a waste of a day![end if]".
The basement part 3 is some text that varies. The basement part 3 is " You scan the room for a safe, and you find a safe.[if c_1 is open and there is something in the c_1] The safe contains [a list of things in the c_1]. Hmmm... what else, what else?[end if]".
The basement part 4 is some text that varies. The basement part 4 is "[if c_1 is open and the c_1 contains nothing] The safe is empty! What a waste of a day![end if]".
The basement part 5 is some text that varies. The basement part 5 is " You see a formless chest.[if c_2 is open and there is something in the c_2] The formless chest contains [a list of things in the c_2].[end if]".
The basement part 6 is some text that varies. The basement part 6 is "[if c_2 is open and the c_2 contains nothing] The formless chest is empty! What a waste of a day![end if]".
The basement part 7 is some text that varies. The basement part 7 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The basement part 8 is some text that varies. The basement part 8 is " gateway leading east. You don't like doors? Why not try going south, that entranceway is unguarded. You don't like doors? Why not try going west, that entranceway is unblocked.".
The description of r_1 is "[basement part 0][basement part 1][basement part 2][basement part 3][basement part 4][basement part 5][basement part 6][basement part 7][basement part 8]".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in a sauna. A typical one. You begin looking for stuff.

 You can make out [if c_3 is locked]a locked[else if c_3 is open]an opened[otherwise]a closed[end if]".
The sauna part 1 is some text that varies. The sauna part 1 is " dresser.[if c_3 is open and there is something in the c_3] The dresser contains [a list of things in the c_3].[end if]".
The sauna part 2 is some text that varies. The sauna part 2 is "[if c_3 is open and the c_3 contains nothing] The dresser is empty! What a waste of a day![end if]".
The sauna part 3 is some text that varies. The sauna part 3 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The sauna part 4 is some text that varies. The sauna part 4 is " gateway leading west. There is an unblocked exit to the north.".
...
The spare room part 0 is some text that varies. The spare room part 0 is "You are in a spare room. An usual one.

 You can see [if c_4 is locked]a locked[else if c_4 is open]an opened[otherwise]a closed[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is " trunk.[if c_4 is open and there is something in the c_4] The trunk contains [a list of things in the c_4]. Now that's what I call TextWorld![end if]".
...
The spare room part 3 is some text that varies. The spare room part 3 is " You make out a shelf. The shelf is usual.[if there is something on the s_0] On the shelf you make out [a list of things on the s_0]. Classic TextWorld.[end if]".
The spare room part 4 is some text that varies. The spare room part 4 is "[if there is nothing on the s_0] But the thing is empty, unfortunately. It would have been so cool if there was stuff on the shelf! oh well.[end if]".
...
The canteen part 0 is some text that varies. The canteen part 0 is "You are in a canteen.
...
The r_1 and the r_4 and the r_2 and the r_0 and the r_3 are rooms.
The r_1 and the r_4 and the r_2 and the r_0 and the r_3 are privately-named.
...
The c_1 is in r_1.
The c_1 is open.
The description of c_2 is "The formless chest looks strong, and impossible to break. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of c_2 is "formless chest".
Understand "formless chest" as c_2.
...
Test quest0_0 with "take passkey from safe / unlock box with passkey / open box / take fly larva from box / drop fly larva"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, recover the passkey from the safe. And then, unlock the box within the basement. Then, make s".
The objective part 1 is some text that varies. The objective part 1 is "ure that the box is opened. And then, retrieve the fly larva from the box within the basement. If you can get your hands on the fly larva, deposit the fly larva on the floor of the basement. And once ".
The objective part 2 is some text that varies. The objective part 2 is "you've done that, you win!".
