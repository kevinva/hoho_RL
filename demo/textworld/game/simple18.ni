...
The studio part 5 is some text that varies. The studio part 5 is " door leading west. There is an unguarded exit to the east.".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You are in a workshop. A standard kind of place. You can barely contain your excitement.
...
The chamber part 1 is some text that varies. The chamber part 1 is " locker nearby.[if c_2 is open and there is something in the c_2] The locker contains [a list of things in the c_2].[end if]".
The chamber part 2 is some text that varies. The chamber part 2 is "[if c_2 is open and the c_2 contains nothing] The locker is empty! What a waste of a day![end if]".
The chamber part 3 is some text that varies. The chamber part 3 is " You make out a bar. The bar is normal.[if there is something on the s_0] On the bar you can see [a list of things on the s_0].[end if]".
The chamber part 4 is some text that varies. The chamber part 4 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of junk.[end if]".
The chamber part 5 is some text that varies. The chamber part 5 is "

There is an unguarded exit to the west.".
The description of r_3 is "[chamber part 0][chamber part 1][chamber part 2][chamber part 3][chamber part 4][chamber part 5]".
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "This might come as a shock to you, but you've just come into a cubicle. You begin to take stock of what's in the room.
...
The study part 1 is some text that varies. The study part 1 is " passageway leading south. There is an unblocked exit to the east.".
...
The c_2 is in r_3.
The c_2 is locked.
The description of f_0 is "The carrot looks tasty.".
The printed name of f_0 is "carrot".
Understand "carrot" as f_0.
The f_0 is in r_1.
The f_0 is edible.
The description of k_1 is "The TextWorld key is cold to the touch".
...
The description of s_0 is "The bar is undependable.".
The printed name of s_0 is "bar".
Understand "bar" as s_0.
The s_0 is in r_3.
The description of k_0 is "The Henderson's style latchkey is heavy.".
...
The description of o_0 is "The cane appears well matched to everything else here".
...
Test quest0_0 with "take TextWorld key / unlock TextWorld box with TextWorld key / open TextWorld box / take Henderson's style latchkey from TextWorld box / unlock Henderson's style chest with Henderson's style latchkey"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to lift the TextWorld key from the floor of the stud".
The objective part 1 is some text that varies. The objective part 1 is "io. And then, unlock the TextWorld box. After that, open the TextWorld box. And then, retrieve the Henderson's style latchkey from the TextWorld box. After that, unlock the Henderson's style chest in ".
The objective part 2 is some text that varies. The objective part 2 is "the studio. And if you do that, you're the winner!".
