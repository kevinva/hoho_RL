...
The r_0 and the r_1 and the r_3 and the r_2 and the r_4 are rooms.

Understand "shower" as r_0.
The internal name of r_0 is "shower".
The printed name of r_0 is "-= Shower =-".
The shower part 0 is some text that varies. The shower part 0 is "You're now in the shower. You can barely contain your excitement.



You need an unblocked exit? You should try going north. There is an exit to the south. Don't worry, it is unguarded. There is an unblocked exit to the west.".
...
The workshop part 1 is some text that varies. The workshop part 1 is " locker.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
...
The canteen part 0 is some text that varies. The canteen part 0 is "You've just sauntered into a canteen. The room is well lit.

 You make out a refrigerator.[if c_1 is open and there is something in the c_1] The refrigerator contains [a list of things in the c_1].[end if]".
The canteen part 1 is some text that varies. The canteen part 1 is "[if c_1 is open and the c_1 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a kitchenette. A typical kind of place.
 ...
 You make out a rack. The rack is normal.[if there is something on the s_0] On the rack you make out [a list of things on the s_0]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The kitchenette part 1 is some text that varies. The kitchenette part 1 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of garbage.[end if]".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You find yourself in a bedchamber. An usual kind of place.

 You can see [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The bedchamber part 1 is some text that varies. The bedchamber part 1 is " portmanteau.[if c_2 is open and there is something in the c_2] The portmanteau contains [a list of things in the c_2].[end if]".
The bedchamber part 2 is some text that varies. The bedchamber part 2 is "[if c_2 is open and the c_2 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
...
The description of r_4 is "[bedchamber part 0][bedchamber part 1][bedchamber part 2][bedchamber part 3]".
...
The r_0 and the r_1 and the r_3 and the r_2 and the r_4 are rooms.
The r_0 and the r_1 and the r_3 and the r_2 and the r_4 are privately-named.
...
The description of o_1 is "The keyboard appears to be well matched to everything else here".
The printed name of o_1 is "keyboard".
Understand "keyboard" as o_1.
The o_1 is in r_1.
The description of o_2 is "The mouse is modern.".
...
The description of o_3 is "The cd is modern.".
...
Test quest0_0 with "go south / go west / take Comic Strip Calendar from locker / go east / drop Comic Strip Calendar"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, travel south. Then, move west. And then, take the Comic Strip Calendar fr".
The objective part 1 is some text that varies. The objective part 1 is "om the locker within the workshop. And then, try to travel east. And then, place the Comic Strip Calendar on the floor of the shower. That's it!".
