...
The r_0 and the r_4 and the r_2 and the r_1 and the r_3 are rooms.

Understand "sauna" as r_0.
The internal name of r_0 is "sauna".
The printed name of r_0 is "-= Sauna =-".
The sauna part 0 is some text that varies. The sauna part 0 is "You have moved into a sauna. Not the sauna you'd expect. No, this is a sauna. You begin to take stock of what's here.
...
The sauna part 1 is some text that varies. The sauna part 1 is "[if c_0 is open and the c_0 contains nothing] The chest is empty! This is the worst thing that could possibly happen, ever![end if]".
The sauna part 2 is some text that varies. The sauna part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a bench. [if there is something on the s_0]On the bench you can see [a list of things on the s_0].[end if]".
The sauna part 3 is some text that varies. The sauna part 3 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of garbage. Oh! Why couldn't there just be stuff on it?[end if]".
The sauna part 4 is some text that varies. The sauna part 4 is " You make out a board. [if there is something on the s_1]You see [a list of things on the s_1] on the board.[end if]".
The sauna part 5 is some text that varies. The sauna part 5 is "[if there is nothing on the s_1]But the thing is empty, unfortunately. What, you think everything in TextWorld should have stuff on it?[end if]".
The sauna part 6 is some text that varies. The sauna part 6 is "

There is an unguarded exit to the east. You need an unguarded exit? You should try going north. There is an exit to the west. Don't worry, it is unguarded.".
The description of r_0 is "[sauna part 0][sauna part 1][sauna part 2][sauna part 3][sauna part 4][sauna part 5][sauna part 6]".
...
The basement part 0 is some text that varies. The basement part 0 is "You've entered a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the basement. You try to gain information on your surroundings by using a technique you call 'looking.'

 Oh, great. Here's a counter. The counter is typical.[if there is something on the s_2] On the counter you make out [a list of things on the s_2].[end if]".
...
The description of r_4 is "[basement part 0][basement part 1][basement part 2]".
...
The cookhouse part 1 is some text that varies. The cookhouse part 1 is "[if there is nothing on the s_3]The chair appears to be empty. It would have been so cool if there was stuff on the chair.[end if]".
The cookhouse part 2 is some text that varies. The cookhouse part 2 is " You make out a saucepan. Now why would someone leave that there? The saucepan is typical.[if there is something on the s_4] On the saucepan you see [a list of things on the s_4].[end if]".
The cookhouse part 3 is some text that varies. The cookhouse part 3 is "[if there is nothing on the s_4] The saucepan appears to be empty.[end if]".
...
The r_0 and the r_4 and the r_2 and the r_1 and the r_3 are rooms.
The r_0 and the r_4 and the r_2 and the r_1 and the r_3 are privately-named.
...
The s_2 is in r_4.
The description of s_3 is "The chair is wobbly.".
...
The description of o_1 is "The blender is clean.".
The printed name of o_1 is "blender".
Understand "blender" as o_1.
...
The description of o_0 is "The sponge appears to be to fit in here".
...
Test quest0_0 with "go east / go south / go west / take sponge from bench / insert sponge into chest"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to travel east. With that over with, attempt to go south. With that done".
The objective part 1 is some text that varies. The objective part 1 is ", attempt to venture west. If you can succeed at that, pick up the sponge from the bench in the sauna. After stealing the sponge, you can deposit the sponge into the chest in the sauna. Alright, thank".
The objective part 2 is some text that varies. The objective part 2 is "s!".
