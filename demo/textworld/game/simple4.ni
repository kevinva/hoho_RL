...
The cookery part 0 is some text that varies. The cookery part 0 is "You arrive in a cookery. A typical kind of place. I guess you better just go and list everything you see here.

 Hey, want to see a type K safe? Look over there, a type K safe.[if c_1 is open and there is something in the c_1] The type K safe contains [a list of things in the c_1].[end if]".
The cookery part 1 is some text that varies. The cookery part 1 is "[if c_1 is open and the c_1 contains nothing] What a letdown! The type K safe is empty![end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "You arrive in a shower. A standard one. Okay, just remember what you're here to do, and everything will go great.

 You scan the room for a board, and you find a board. The board is typical.[if there is something on the s_0] On the board you make out [a list of things on the s_0].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Wow! You're in a pantry. You begin to take stock of what's in the room.

 You see [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is " trunk.[if c_2 is open and there is something in the c_2] The trunk contains [a list of things in the c_2].[end if]".
The pantry part 2 is some text that varies. The pantry part 2 is "[if c_2 is open and the c_2 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
...
The parlor part 0 is some text that varies. The parlor part 0 is "You find yourself in a parlor. An ordinary one.
 ...
 You make out a portmanteau. There's something strange about this being here, but you can't put your finger on it.[if c_0 is open and there is something in the c_0] The portmanteau contains [a list of things in the c_0].[end if]".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've just walked into a cookhouse. The room is well lit.
...
The description of c_0 is "The portmanteau looks strong, and impossible to crack. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
The printed name of c_0 is "portmanteau".
Understand "portmanteau" as c_0.
The c_0 is in r_0.
The c_0 is open.
The description of c_1 is "The type K safe looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of c_1 is "type K safe".
Understand "type K safe" as c_1.
...
The c_2 is in r_3.
The c_2 is open.
The description of k_0 is "The type K keycard is cold to the touch".
The printed name of k_0 is "type K keycard".
Understand "type K keycard" as k_0.
...
The description of f_2 is "that's a typical onion!".
...
The description of o_0 is "The spoon appears well matched to everything else here".
...
Test quest0_0 with "go west / take stick of butter from portmanteau / go east / go north / eat stick of butter"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First, it would be a great idea if you could attempt to go to the we".
The objective part 1 is some text that varies. The objective part 1 is "st. Then, recover the stick of butter from the portmanteau within the parlor. After that, eat the stick of butter. Once that's all handled, you can stop!".
