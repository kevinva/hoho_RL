...
The steam room part 0 is some text that varies. The steam room part 0 is "You are in a steam room. It seems to be pretty usual here.

 Were you looking for a Henderson's limited edition chest? Because look over there, it's a Henderson's limited edition chest.[if c_0 is open and there is something in the c_0] The Henderson's limited edition chest contains [a list of things in the c_0].[end if]".
The steam room part 1 is some text that varies. The steam room part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The Henderson's limited edition chest is empty![end if]".
The steam room part 2 is some text that varies. The steam room part 2 is " You see a gleam over in a corner, where you can see a counter. [if there is something on the s_0]You see [a list of things on the s_0] on the counter. It doesn't get more TextWorld than this![end if]".
The steam room part 3 is some text that varies. The steam room part 3 is "[if there is nothing on the s_0]The counter appears to be empty.[end if]".
The steam room part 4 is some text that varies. The steam room part 4 is " You scan the room, seeing a rack. [if there is something on the s_1]On the rack you make out [a list of things on the s_1].[end if]".
The steam room part 5 is some text that varies. The steam room part 5 is "[if there is nothing on the s_1]But the thing hasn't got anything on it.[end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "Well I'll be, you are in the place we're calling the studio.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. A typical kind of place. You begin to take stock of what's in the room.

 You can see [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The cubicle part 1 is some text that varies. The cubicle part 1 is " trunk close by.[if c_1 is open and there is something in the c_1] The trunk contains [a list of things in the c_1].[end if]".
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You've just sauntered into a dish-pit. You begin looking for stuff.

 Look over there! a case.[if c_2 is open and there is something in the c_2] The case contains [a list of things in the c_2].[end if]".
The dish-pit part 1 is some text that varies. The dish-pit part 1 is "[if c_2 is open and the c_2 contains nothing] The case is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You've just sauntered into a kitchenette. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The description of c_0 is "The Henderson's limited edition chest looks strong, and impossible to crack. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_2 is in r_3.
The c_2 is closed.
The description of f_1 is "The cucumber looks tempting.".
...
The s_1 is in r_1.
The description of f_0 is "that's a standard cabbage!".
...
The description of o_1 is "The paper towel looks to fit in here".
The printed name of o_1 is "paper towel".
Understand "paper towel" as o_1.
Understand "paper" as o_1.
Understand "towel" as o_1.
The player carries the o_1.
The description of k_0 is "The metal of the Henderson's limited edition keycard is rusty.".
...
Test quest0_0 with "go west / go south / go east / take Henderson's limited edition keycard from counter / unlock Henderson's limited edition chest with Henderson's limited edition keycard"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound round of TextWorld! First of all, you could, like, make an attempt to go west. And then, move south. After that, attempt to head east. And then, take the Henderson's lim".
The objective part 1 is some text that varies. The objective part 1 is "ited edition keycard from the counter. After you have taken the Henderson's limited edition keycard, check that the Henderson's limited edition chest inside the steam room is unlocked with the Henders".
The objective part 2 is some text that varies. The objective part 2 is "on's limited edition keycard. Alright, thanks!".
