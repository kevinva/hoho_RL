...
The r_1 and the r_0 and the r_3 and the r_4 and the r_2 are rooms.

Understand "sauna" as r_1.
The internal name of r_1 is "sauna".
The printed name of r_1 is "-= Sauna =-".
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. A standard kind of place.

 You make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The sauna part 1 is some text that varies. The sauna part 1 is " chest right there by you.[if c_0 is open and there is something in the c_0] The chest contains [a list of things in the c_0].[end if]".
The sauna part 2 is some text that varies. The sauna part 2 is "[if c_0 is open and the c_0 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
The sauna part 3 is some text that varies. The sauna part 3 is "

There is an exit to the west. Don't worry, it is unguarded.".
The description of r_1 is "[sauna part 0][sauna part 1][sauna part 2][sauna part 3]".
...
The kitchen part 1 is some text that varies. The kitchen part 1 is " passageway leading south. You need an unguarded exit? You should try going east. You don't like doors? Why not try going north, that entranceway is unguarded.".
The description of r_0 is "[kitchen part 0][kitchen part 1]".

south of r_0 and north of r_3 is a door called d_0.
...
The studio part 0 is some text that varies. The studio part 0 is "Well, here we are in the studio.

 You make out a stand. The stand is standard.[if there is something on the s_0] On the stand you can see [a list of things on the s_0]. It doesn't get more TextWorld than this![end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if there is nothing on the s_0] But there isn't a thing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
The studio part 2 is some text that varies. The studio part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The studio part 3 is some text that varies. The studio part 3 is " passageway leading north. There is an unblocked exit to the west.".
The description of r_3 is "[studio part 0][studio part 1][studio part 2][studio part 3]".

The r_4 is mapped west of r_3.
north of r_3 and south of r_0 is a door called d_0.
...
The office part 1 is some text that varies. The office part 1 is " box.[if c_1 is open and there is something in the c_1] The box contains [a list of things in the c_1]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The office part 2 is some text that varies. The office part 2 is "[if c_1 is open and the c_1 contains nothing] The box is empty, what a horrible day![end if]".
The office part 3 is some text that varies. The office part 3 is "

There is an unblocked exit to the east.".
The description of r_4 is "[office part 0][office part 1][office part 2][office part 3]".
...
The o_2 and the o_4 and the o_0 and the o_1 and the o_3 are object-likes.
The o_2 and the o_4 and the o_0 and the o_1 and the o_3 are privately-named.
The r_1 and the r_0 and the r_3 and the r_4 and the r_2 are rooms.
The r_1 and the r_0 and the r_3 and the r_4 and the r_2 are privately-named.
...
The c_1 is in r_4.
The c_1 is locked.
The description of o_2 is "The whisk is cheap looking.".
The printed name of o_2 is "whisk".
Understand "whisk" as o_2.
The o_2 is in r_0.
The description of o_4 is "The spork looks well matched to everything else here".
...
The description of o_0 is "The insect is cheap looking.".
The printed name of o_0 is "insect".
Understand "insect" as o_0.
The o_0 is in the c_0.
The description of o_1 is "The broom appears well matched to everything else here".
The printed name of o_1 is "broom".
Understand "broom" as o_1.
The o_1 is in the c_0.
The description of o_3 is "The pair of headphones is antiquated.".
...
Test quest0_0 with "go east / open passageway / go north / go east / close chest"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First of all, venture east. And then, ensure that the passageway is open. And then, go to the north. Then, take a trip east. I".
The objective part 1 is some text that varies. The objective part 1 is "f you can get through with that, look and see that the chest is closed. Alright, thanks!".
