...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You find yourself in a dish-pit. An ordinary kind of place.

 Oh wow! Is that what I think it is? It is! It's a shelf. [if there is something on the s_0]You see [a list of things on the s_0] on the shelf.[end if]".
The dish-pit part 1 is some text that varies. The dish-pit part 1 is "[if there is nothing on the s_0]Looks like someone's already been here and taken everything off it, though. What's the point of an empty shelf?[end if]".
...
The lounge part 0 is some text that varies. The lounge part 0 is "You arrive in a lounge. A typical one.

 You smell an awful smell, and follow it to a couch. [if there is something on the s_1]On the couch you can see [a list of things on the s_1].[end if]".
The lounge part 1 is some text that varies. The lounge part 1 is "[if there is nothing on the s_1]But the thing is empty.[end if]".
...
The washroom part 0 is some text that varies. The washroom part 0 is "Well, here we are in a washroom. You start to take note of what's in the room.

 Look over there! a counter. [if there is something on the s_2]You see [a list of things on the s_2] on the counter.[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is "[if there is nothing on the s_2]Looks like someone's already been here and taken everything off it, though. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The description of r_1 is "[washroom part 0][washroom part 1][washroom part 2]".
...
The parlor part 0 is some text that varies. The parlor part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a parlor. You can barely contain your excitement.

 You can see a bed. The bed is usual.[if there is something on the s_3] On the bed you see [a list of things on the s_3]. Classic TextWorld.[end if]".
The parlor part 1 is some text that varies. The parlor part 1 is "[if there is nothing on the s_3] But the thing hasn't got anything on it.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A normal one. Okay, just remember what you're here to do, and everything will go great.

 You can see a bar. [if there is something on the s_4]On the bar you can make out [a list of things on the s_4].[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_4]But the thing is empty.[end if]".
...
The f_1 is in r_3.
The f_1 is edible.
The description of o_0 is "The nest of ticks is well-used.".
...
The s_2 is in r_1.
The description of s_3 is "The bed is solid.".
The printed name of s_3 is "bed".
Understand "bed" as s_3.
The s_3 is in r_2.
The description of s_4 is "The bar is solid.".
The printed name of s_4 is "bar".
Understand "bar" as s_4.
The s_4 is in r_4.
The description of f_0 is "that's an ordinary carrot!".
...
The description of o_2 is "The mop seems to fit in here".
...
Test quest0_0 with "go north / go east / go south / take nest of ticks / put nest of ticks on shelf"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First of all, you could, like, move north. After that, make an effort to go to the east. Then, try to head south. After that, recover the nest of tic".
The objective part 1 is some text that varies. The objective part 1 is "ks from the floor of the dish-pit. Then, sit the nest of ticks on the shelf. Alright, thanks!".
