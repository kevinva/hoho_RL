...
The vault part 0 is some text that varies. The vault part 0 is "You arrive in a vault. An ordinary kind of place. Let's see what's in here.

 You make out [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The vault part 1 is some text that varies. The vault part 1 is " locker.[if c_0 is open and there is something in the c_0] The locker contains [a list of things in the c_0].[end if]".
The vault part 2 is some text that varies. The vault part 2 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The locker is empty![end if]".
The vault part 3 is some text that varies. The vault part 3 is " You can make out [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The vault part 4 is some text that varies. The vault part 4 is " display close by.[if c_1 is open and there is something in the c_1] The display contains [a list of things in the c_1].[end if]".
The vault part 5 is some text that varies. The vault part 5 is "[if c_1 is open and the c_1 contains nothing] The display is empty! This is the worst thing that could possibly happen, ever![end if]".
The vault part 6 is some text that varies. The vault part 6 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The vault part 7 is some text that varies. The vault part 7 is " gate leading west. There is an unguarded exit to the north. You don't like doors? Why not try going south, that entranceway is unblocked.".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Well I'll be, you are in the place we're calling the cookhouse.

 You see a saucepan. The saucepan is normal.[if there is something on the s_0] On the saucepan you can make out [a list of things on the s_0], so there's that.[end if]".
The cookhouse part 1 is some text that varies. The cookhouse part 1 is "[if there is nothing on the s_0] But there isn't a thing on it. Silly saucepan, silly, empty, good for nothing saucepan.[end if]".
The cookhouse part 2 is some text that varies. The cookhouse part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The cookhouse part 3 is some text that varies. The cookhouse part 3 is " gate leading east. There is an exit to the north. Don't worry, it is unguarded.".
...
The closet part 0 is some text that varies. The closet part 0 is "Guess what, you are in a place we're calling a closet.

 You make out [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The closet part 1 is some text that varies. The closet part 1 is " toolbox here.[if c_2 is open and there is something in the c_2] The toolbox contains [a list of things in the c_2]. Classic TextWorld.[end if]".
The closet part 2 is some text that varies. The closet part 2 is "[if c_2 is open and the c_2 contains nothing] The toolbox is empty! What a waste of a day![end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You are in a workshop. An ordinary kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The study part 0 is some text that varies. The study part 0 is "You arrive in a study. A normal kind of place. I guess you better just go and list everything you see here.

 What's that over there? It looks like it's a chair. [if there is something on the s_1]You see [a list of things on the s_1] on the chair.[end if]".
...
The c_2 is in r_0.
The c_2 is open.
The description of s_0 is "The saucepan is durable.".
...
The description of o_1 is "The butterfly is expensive looking.".
...
Test quest0_0 with "take keycard from display / unlock locker with keycard / open locker / take fondue from locker / eat fondue"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting episode of TextWorld! First off, if it's not too much trouble, I need you to recover the keycard from the display. Then, insert the keycard into the locker's lock to unlock".
The objective part 1 is some text that varies. The objective part 1 is " it. And then, make it so that the locker is open. And then, retrieve the fondue from the locker inside the vault. After that, eat the fondue. Got that? Good!".
